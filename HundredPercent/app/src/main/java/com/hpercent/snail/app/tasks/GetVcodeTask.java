 ...
 */
public class GetVcodeTask extends BaseTask {
    private PostDataTask mPostDataTask = null;

    private String mPhone = "";

    public GetVcodeTask(Context context, String phone){
        super(context);
        mPhone = phone;
        // post 参数
        PostParameter param = new PostParameter();
        param.add("mobile", phone);
        mPostDataTask = new PostDataTask(UrlConfig.GET_VCODE_FOR_REGISTE, param) {
            @Override
