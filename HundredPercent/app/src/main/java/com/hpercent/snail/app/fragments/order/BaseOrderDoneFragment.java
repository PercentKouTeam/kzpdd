 ...
 */
public class BaseOrderDoneFragment extends BaseOrderFragment {
    ...
    public View setLayout() {
        return mInflater.inflate(R.layout.fragment_order_done, mContainer, false);
    }

    @Override
    public void initView() {
        mOrderTypeController.changeItem(MainActivity.ORDER_DONE);
    }
